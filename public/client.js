...
function onDocumentMouseMove( event ) {
    ...
    if ( intersects.length > 0 ) {
        ...
        cube1.position.copy( intersect.point ).add( intersect.face.normal );
        cube1.position.divideScalar( 50 ).floor().multiplyScalar( 50 ).addScalar( 25 );
...
function onDocumentMouseDown( event ) {
    ...
    const intersects = raycaster.intersectObjects( cubeInfo );
